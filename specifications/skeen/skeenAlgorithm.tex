...
\@pvspace{8.0pt}%
 ...
 deliverable ,\, pc ,\, sentM ,\, sentTS {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{10.0}%
...
\@x{\@s{16.4} \.{\land} sentTS \.{'} \.{=} sentTS}%
\@x{\@s{16.4} \.{\land} LC \.{'} \.{=}\@s{4.1} LC}%
\@pvspace{8.0pt}%
\@x{ ReceivedMessageExpression ( self ,\, i ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} received \.{'} \.{=} [ received {\EXCEPT} {\bang} [
 self ] \.{=} received [ self ] \.{\cup} \{ {\langle} i [ 1 ] ,\, LC [ self ]
 {\rangle} \} ]}%
 \@x{\@s{16.4} \.{\land} sentTS \.{'} \.{=} sentTS \.{\cup} \{ {\langle} self
 ,\,\@w{MESSAGE} ,\, LC [ self ] ,\, i [ 1 ] {\rangle} \}}%
\@pvspace{16.0pt}%
\@x{ ReceivedMessage ( self ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} \A\, i \.{\in} sentM \.{:} ReceivedMessageExpression
 ( self ,\, i )}%
